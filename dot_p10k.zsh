# Generated by Powerlevel10k configuration wizard on 2021-06-27 at 15:34 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 21229.
# Wizard options: ascii, lean, 24h time, 2 lines, dotted, dark-ornaments, sparse,
...
() {
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=79
  ...
  ####################################[ history: history of commandline ]####################################
  # History index color
  typeset -g POWERLEVEL9K_HISTORY_FOREGROUND=189
